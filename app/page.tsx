...
export default function LandingPage() {
  ...
  const plans = {
    pt: [
      ...
      { name: 'Starter', price: '$19', period: '/mês', desc: 'Para lojas que estão começando', features: ['100 try-ons por mês', '5 imagens Studio Pro/mês', 'Excedente: $0,17 prova / $0,15 imagem', 'Painel de análise de dados', 'Suporte padrão'], cta: 'Assinar Starter', highlight: false },
      { name: 'Growth', price: '$29', period: '/mês', desc: 'Para lojas em crescimento', features: ['200 try-ons por mês', '10 imagens Studio Pro/mês', 'Excedente: $0,15 prova / $0,15 imagem', 'Analytics + dados de conversão', 'Suporte prioritário'], cta: 'Assinar Growth', highlight: true, badge: 'Mais popular' },
      { name: 'Pro', price: '$59', period: '/mês', desc: 'Para lojas que querem escalar', features: ['500 try-ons por mês', '10 imagens Studio Pro/mês', 'Excedente: $0,12 prova / $0,15 imagem', 'Analytics comportamental completo', 'Suporte VIP'], cta: 'Assinar Pro', highlight: false },
      { name: 'Enterprise', price: '$109', period: '/mês', desc: 'Para operações de alto volume', features: ['1.000 try-ons por mês', '10 imagens Studio Pro/mês', 'Excedente: $0,10 prova / $0,15 imagem', 'Analytics avançado completo', 'Suporte dedicado'], cta: 'Falar com vendas', highlight: false },
    ],
    en: [
      ...
      { name: 'Starter', price: '$19', period: '/month', desc: 'For stores just getting started', features: ['100 try-ons per month', '5 Studio Pro images/month', 'Overage: $0.17 per try-on / $0.15 per image', 'Data analytics panel', 'Standard support'], cta: 'Get Starter', highlight: false },
      { name: 'Growth', price: '$29', period: '/month', desc: 'For growing stores', features: ['200 try-ons per month', '10 Studio Pro images/month', 'Overage: $0.15 per try-on / $0.15 per image', 'Analytics + conversion data', 'Priority support'], cta: 'Get Growth', highlight: true, badge: 'Most popular' },
      { name: 'Pro', price: '$59', period: '/month', desc: 'For stores that want to scale', features: ['500 try-ons per month', '10 Studio Pro images/month', 'Overage: $0.12 per try-on / $0.15 per image', 'Full behavioral analytics', 'VIP support'], cta: 'Get Pro', highlight: false },
      { name: 'Enterprise', price: '$109', period: '/month', desc: 'For high-volume operations', features: ['1,000 try-ons per month', '10 Studio Pro images/month', 'Overage: $0.10 per try-on / $0.15 per image', 'Full advanced analytics', 'Dedicated support'], cta: 'Talk to sales', highlight: false },
    ],
  };
